...
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (1, 'Holes in My Shoes', '2h 40m', 'Documentary', 10);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (2, 'Have Dreams, Will Travel', '2h 21m', 'Drama|Romance', 16);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (3, 'Kinbaku', '1h 38m', 'Documentary', 12);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (4, 'Kahaani', '3h 11m', 'Crime|Drama|Thriller', 10);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (5, 'Reservoir Dogs', '2h 9m', 'Crime|Mystery|Thriller', 16);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (6, 'History Is Made at Night', '1h 20m', 'Drama|Romance', 18);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (7, 'Princess and the Pony', '1h 50m', 'Children|Drama', 14);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (8, 'Carpetbaggers, The', '2h 10m', 'Drama', 14);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (9, 'Smilla''s Sense of Snow', '1h 45m', 'Drama|Thriller', 12);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (10, 'Crazy/Beautiful', '2h 35m', 'Drama|Romance', 14);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (11, 'Face of Another, The (Tanin no kao)', '2h 20m', 'Drama|Sci-Fi', 10);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (12, 'Moon in the Gutter, The (La lune dans le caniveau)', '1h 56m', 'Drama', 16);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (13, 'Udaan', '2h 10m', 'Drama', 16);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (14, 'Christmas in August (Palwolui Christmas)', '2h 17m', 'Drama|Romance', 10);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (15, 'Hear No Evil', '1h 45m', 'Thriller', 10);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (16, 'Charleston', '2h 59m', 'Comedy|Crime', 18);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (17, 'Anderson Tapes, The', '1h 30m', 'Crime|Drama|Thriller', 18);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (18, 'Mummy, The', '2h 15m', 'Action|Adventure|Comedy|Fantasy|Horror|Thriller', 16);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (19, 'Mr. Magorium''s Wonder Emporium', '1h 49m', 'Children|Comedy|Fantasy', 14);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (20, 'Dry Summer (Susuz yaz) (Reflections)', '2h 13m', 'Drama', 14);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (21, 'Drummer-Crab (Le Crabe-Tambour)', '3h 10m', 'Adventure|Drama|War',107);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (22, 'Yertle the Turtle and Other Stories', '1h 37m', 'Animation|Children', 10);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (23, 'Gentlemen', '1h 58m', 'Drama|Romance|Thriller', 14);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (24, 'Bullhead (Rundskop)', '1h 40m', 'Crime|Drama', 18);
insert into Filmes (id_ingresso, nome_filme, duracao, genero, classiicacao_etaria) values (25, 'First Love', '2h 27m', 'Comedy|Musical', 12);